...
function InteractiveTopRail() {
  const [eventId, setEventId] = useState<(typeof WCA_EVENTS)[number]["id"]>("333");
  ...
  return <RankingsJumpRail
    ...
    onSearchClose={() => { setFindOpen(false); setQuery(""); }}
...
export const Bottom: Story = {
  args: { upArmed: true },
  render: (args) => <JumpControlsVisibility visible><RankingsPagerRail {...args} /></JumpControlsVisibility>,
};
